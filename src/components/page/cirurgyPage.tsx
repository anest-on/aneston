...
export default function CirurgyPage({
  ...
  const [pacientPhysicalActivityStyle, setPacientPhysicalActivityStyle] =
    useState(['', 'hidden'])
  const [pacientAnestheticStyle, setPacientAnestheticStyle] = useState([
    '',
    'hidden',
  ])
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      pacient_when_stop_smoking:
        setCirurgyData?.pacient_when_stop_smoking || '',
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div>
              ...
              <FormItem>
                <FormControl>
                  <RadioFormItem
                    ...
                    onChange={field.onChange}
                    inputValue={(value: boolean) =>
                      handleInputChange(value, setPacientPhysicalActivityStyle)
                    }
                    className={pacientPhysicalActivityStyle[0]}
                  >
          ...
          <div
            className={`${pacientPhysicalActivityStyle[1]} bg-gray-800 w-full px-5 py-3 rounded-b-md border-dashed border-gray-200 border-b-[2px] border-r-[2px] border-l-[2px]`}
          >
            <FormField
              control={form.control}
        ...
        <div>
          <FormField
            control={form.control}
            name="pacient_has_anesthetic_complication"
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <RadioFormItem
                    ...
                    onChange={field.onChange}
                    inputValue={(value: boolean) =>
                      handleInputChange(value, setPacientAnestheticStyle)
                    }
                    className={pacientAnestheticStyle[0]}
                  >
          ...
          <div
            className={`${pacientAnestheticStyle[1]} bg-gray-800 w-full px-5 py-3 rounded-b-md border-dashed border-gray-200 border-b-[2px] border-r-[2px] border-l-[2px]`}
          >
            <FormField
              control={form.control}
              name="pacient_anesthetic_complications"
              render={({ field }) => (
                <FormItem>
                  <FormControl>
