...
> {
  ...
  renderTimeLabel = (time: Date): JSX.Element => {
    if (this.props.renderTimeLabel) {
      ...
      const formatedTime = formatDate(time, this.props.timeFormat).replace(
        ':',
        'h',
      )
      return <TimeText>{formatedTime}</TimeText>
    }
  }
  ...
  renderDateLabel = (date: Date): JSX.Element => {
    if (this.props.renderDateLabel) {
      ...
      const formatedDate = formatDate(date, this.props.dateFormat)
      if (formatedDate === '111') {
        return (
          <DateLabel>
            <b>Dom</b>
      ...
      } else if (formatedDate === '222') {
        return (
          <DateLabel>
            <b>Seg</b>
          </DateLabel>
        )
      } else if (formatedDate === '333') {
        return (
          <DateLabel>
            <b>Ter</b>
          </DateLabel>
        )
      } else if (formatedDate === '444') {
        return (
          <DateLabel>
            <b>Qua</b>
          </DateLabel>
        )
      } else if (formatedDate === '555') {
        return (
          <DateLabel>
            <b>Qui</b>
          </DateLabel>
        )
      } else if (formatedDate === '666') {
        return (
          <DateLabel>
            <b>Sex</b>
          </DateLabel>
        )
      } else if (formatedDate === '777') {
        return (
          <DateLabel>
            <b>Sab</b>
          </DateLabel>
        ...
        return <DateLabel>{formatedDate}</DateLabel>
      }
    }
  }
